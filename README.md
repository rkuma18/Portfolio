...
| [Amazon Fine Food Reviews Analysis]([https://github.com/rkuma18/1_ML_QuoraQuestionPairs](https://github.com/rkuma18/DS_Amazon-Fine-Food-Reviews-Analysis)) |Machine Learning| This repository contains code for analyzing and predicting sentiment from Amazon Fine Food Reviews dataset. The code is implemented in Python and utilizes various natural language processing (NLP) techniques and machine learning algorithms.| `python`, `sklearn`, `pandas`, `numpy`, `XGBoost`, `nltk`,`gensim` |
